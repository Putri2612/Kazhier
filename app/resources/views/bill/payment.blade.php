...
{{ Form::open(array('route' => array('bill.payment', $bill->id),'method'=>'post',  'onsubmit' => 'return validateCurrencyInput(this)')) }}
<div class="row">
    ...
    <div class="form-group  col-md-6">
        ...
        <div class="input-group">
            ...
            {{ Form::text('amount',number_format($bill->getDue(), 2, ',', '.'),null, array('class' => 'form-control','required'=>'required', 'data-is-number')) }}
        </div>
    </div>
    <div class="form-group  col-md-6">
        <div class="input-group">
