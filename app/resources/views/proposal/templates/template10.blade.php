                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$proposal->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div data-v-b8f60a0c="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                <div data-v-f2a183a6="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$proposal->getSubTotal())}}</div>
                                                </div>
                                                @if($proposal->discount_apply==1)
                                                ...
                                                @if($proposal->getTotalTax())
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$proposal->getTotalTax())}}</div>
                                                    </div>
                                                @endif
