                                                        ...
                                                        <table class="table table-flush" id="">
                                                            ...
                                                            @foreach ($bills as $bill)
                                                                ...
                                                                <tr class="font-style">
                                                                    ...
                                                                    <td>
                                                                        @if($bill->status == 0)
                                                                            <b><span class="text-primary">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span></b>
                                                                        @elseif($bill->status == 1)
                                                                            <b> <span class="text-warning">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span></b>
                                                                        @elseif($bill->status == 2)
                                                                            <b> <span class="text-danger">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span></b>
                                                                        @elseif($bill->status == 3)
                                                                            <b> <span class="text-info">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span></b>
                                                                        @elseif($bill->status == 4)
                                                                            <b> <span class="text-success">{{ __(\App\Models\Invoice::$statues[$bill->status]) }}</span></b>
                                                                        @endif
                                                                    </td>
