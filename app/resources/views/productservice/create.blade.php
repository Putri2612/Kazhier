    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::number('sale_price', '', array('class' => 'form-control','required'=>'required','step'=>'1000')) }}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::number('purchase_price', '', array('class' => 'form-control','required'=>'required','step'=>'1000')) }}
            </div>
        </div>
    </div>
