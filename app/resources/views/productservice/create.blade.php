    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::text('sale_price', '', array('class' => 'form-control','required'=>'required', 'data-is-number')) }}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::text('purchase_price', '', array('class' => 'form-control','required'=>'required', 'data-is-number')) }}
            </div>
        </div>
    </div>
