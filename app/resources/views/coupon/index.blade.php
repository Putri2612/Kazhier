        ...
        <div class="row">
            <div class="col-12">
                <div class="row crd mb-3">
                    <h4 class="col-6 font-weight-normal">{{__('Manage Coupon')}}</h4>
                    @can('create coupon')
                                            ...
                                            @foreach ($coupons as $coupon)
                                                ...
                                                <tr class="font-style">
                                                    ...
                                                    <td class="action text-right">
                                                        ...
                                                        @endcan
                                                        @can('delete coupon')
                                                            <a href="#" class="btn btn-danger btn-action " data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?')}}|{{__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$coupon->id}}').submit();">
