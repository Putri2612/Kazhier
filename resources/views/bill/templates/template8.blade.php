                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-136bf9b5="">
                                                ...
                                                <td data-v-136bf9b5="" class="text-end">{{$bill->billNumber()}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{Helper::dateFormat($bill->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-136bf9b5="">
                                                <td data-v-136bf9b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-136bf9b5="" class="text-end">{{Helper::dateFormat($bill->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
