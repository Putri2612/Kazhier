                                        ...
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr data-v-363339a0="">
                                                    ...
                                                    <td data-v-363339a0="" class="text-end">{{$bill->billNumber()}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-end">{{Helper::dateFormat($bill->issue_date)}}</td>
                                                </tr>
                                                <tr data-v-363339a0="">
                                                    <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                    <td data-v-363339a0="" class="text-end">{{Helper::dateFormat($bill->due_date)}}</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                @if($bill->getTotalTax())
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$bill->getTotalTax())}}</div>
                                                    </div>
                                                @endif
