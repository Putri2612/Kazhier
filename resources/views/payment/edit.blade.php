{{ Form::model($payment, array('route' => array('payment.update', $payment->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return ValidateForm(event)')) }}
...
<div class="row">
    ...
    <div class="form-group  col-md-6">
        <div class="input-group">
            ...
            {{ Form::select('vender_id', $venders,null, array('class' => 'form-control customer-sel font-style selectric', 'data-is-required', 'data-is-not-highlighted')) }}
        </div>
    </div>
    ...
    <div class="form-group  col-md-6">
        ...
        <div class="input-group">
            <div class="fileinput fileinput-exists" data-provides="fileinput">
                ...
                {{ ($mime == "pdf" ? '<div class="fileinput-new">' . $payment->reference . '</div>' : '') }} 
                <div class="fileinput-new thumbnail h-150">
                    <img src="{{$ref.'/'.$payment->reference.'?'.rand()}}" alt="">
                </div>
