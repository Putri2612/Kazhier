                                ...
                                <div data-v-e23d9750="" class="d-inner">
                                    <div data-v-e23d9750="" class="row">
                                        <div data-v-e23d9750="" class="col-66">
                                            <h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};">{{__('INVOICE')}}</h1>
                                        </div>
                                            ...
                                            <table data-v-e23d9750="" class="summary-table">
                                                <tbody data-v-e23d9750="">
                                                    <tr data-v-e23d9750="">
                                                        ...
                                                        <td data-v-e23d9750="" class="text-end">{{$invoice->invoiceNumber()}}</td>
                                                    </tr>
                                                    <tr data-v-e23d9750="">
                                                        <td data-v-e23d9750="" class="tu fwb">{{__('Issue Date')}}:</td>
                                                        <td data-v-e23d9750="" class="text-end">{{Helper::dateFormat($invoice->issue_date)}}</td>
                                                    </tr>
                                                    <tr data-v-e23d9750="">
                                                        <td data-v-e23d9750="" class="tu fwb">{{__('Due Date')}}:</td>
                                                        <td data-v-e23d9750="" class="text-end">{{Helper::dateFormat($invoice->due_date)}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
