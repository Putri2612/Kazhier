                                ...
                                <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                    <div data-v-1ad6e3b9="" class="row grey-box">
                                        ...
                                        <div data-v-1ad6e3b9="" class="col-33">
                                            <h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                            <table data-v-1ad6e3b9="" class="summary-table">
                                                <tbody data-v-1ad6e3b9="">
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{__('Number')}}:</td>
                                                        <td data-v-1ad6e3b9="" class="text-end">{{$invoice->invoiceNumber()}}</td>
                                                    </tr>
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{__('Issue Date')}}:</td>
                                                        <td data-v-1ad6e3b9="" class="text-end">{{Helper::dateFormat($invoice->issue_date)}}</td>
                                                    </tr>
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{__('Due Date')}}:</td>
                                                        <td data-v-1ad6e3b9="" class="text-end">{{Helper::dateFormat($invoice->due_date)}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
