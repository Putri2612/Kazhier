                                            ...
                                            <table data-v-4b3dcb8a="" class="summary-table">
                                                <tbody data-v-4b3dcb8a="">
                                                    <tr data-v-4b3dcb8a="">
                                                        ...
                                                        <td data-v-4b3dcb8a="" class="text-end">{{$invoice->invoiceNumber()}}</td>
                                                    </tr>
                                                    <tr data-v-4b3dcb8a="">
                                                        <td data-v-4b3dcb8a="" class="fwb">{{__('Issue Date')}}:</td>
                                                        <td data-v-4b3dcb8a="" class="text-end">{{Helper::dateFormat($invoice->issue_date)}}</td>
                                                    </tr>
                                                    <tr data-v-4b3dcb8a="">
                                                        <td data-v-4b3dcb8a="" class="fwb">{{__('Due Date')}}:</td>
                                                        <td data-v-4b3dcb8a="" class="text-end">{{Helper::dateFormat($invoice->due_date)}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
