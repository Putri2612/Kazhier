            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-3">
                            <div class="text-small float-right fw-bold text-muted">{{$billChartData['progressData']['totalBill'] .'/'.$billChartData['progressData']['totalUnpaidBill']}}</div>
                        ...
                        <div class="col-3">
                            <div class="text-small float-right fw-bold text-muted">{{$billChartData['progressData']['totalBill'] .'/'.$billChartData['progressData']['totalPaidBill']}}</div>
                        ...
                        <div class="col-3">
                            <div class="text-small float-right fw-bold text-muted">{{$billChartData['progressData']['totalBill'] .'/'.$billChartData['progressData']['totalPartialBill']}}</div>
                        ...
                        <div class="col-3">
                            <div class="text-small float-right fw-bold text-muted">{{$billChartData['progressData']['totalBill'] .'/'.$billChartData['progressData']['totalDueBill']}}</div>
